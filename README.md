...
1. User menjalankan aplikasi → GUI terbuka.
2. Aplikasi otomatis memuat daftar console dan data penyewaan dari database.
3. User mengisi data pelanggan pada form.
4. User memilih jenis console dan durasi penyewaan.

User dapat menekan tombol:

- **Tambah** → Menyimpan data baru
- **Edit** → Memperbarui data penyewaan
...
5. **Instance Object** → Digunakan untuk memanipulasi data penyewaan console
